...
![图 11.5](/posts/images/11.5.png)

我们加了一个抓取器，来提取 `node`, `topic` 两个字段。

在 webui 查看该 input 的 message：

![图 11.4](/posts/images/11.4.png)
...
![图 11.8](/posts/images/11.8.png)

创建一个 HTTP 回调：

![图 11.9](/posts/images/11.9.png)
...
![图 11.10](/posts/images/11.10.png)
